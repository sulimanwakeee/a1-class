...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Update And Save the Form");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_phone, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         String ssname = txt_name.getText();
         String sclass = txt_class.getText();
      ...
      try{
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost/test?username=root&password=");
        Statement st = con.createStatement();
        st.execute("UPDATE students SET sname = '" + ssname + "', class = '" + sclass + "', phone = '" + sphone + "' WHERE sid = " + ShowTables.sid);
        this.setVisible(false);
      javax.swing.JOptionPane.showMessageDialog(null, "succesfully inserted");
